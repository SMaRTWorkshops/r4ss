...
a) Use your graphic from Question 2(c) a starting graphic object. Apply the "classic" complete theme to it and move the legend to the top. *Bonus:* Also make the axis titles italic (you may need to check a cheatsheet or do some searching to find the right element).
...
- [GGP2 Chapter 8](https://ggplot2-book.org/annotations.html): Read about annotating ggplot2 objects

- [GGP2 Chapter 17](https://ggplot2-book.org/facet.html): Read about faceting in ggplot2

## Fun Stuff

### How to Spot a Misleading Graph

Here are some mistakes to avoid (unless you want to work at a shitty newspaper)...

<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/E91bGT9BjYk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

### Don McMillan's Gratest Charts
